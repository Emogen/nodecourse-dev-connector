 ...
 * AddExperience
 */
class AddExperience extends Component { // eslint-disable-line react/prefer-stateless-function
  constructor(props){
    super(props);
    this.state = {
      company: '',
        ...
        <div className="container">
          <div className="row">
            <div className = "col-md-8 m-auto">
              ...
              <p className="lead text-center">Add any job ir position that you have had in the past or current</p>
